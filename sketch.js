...
function mousePressed() 
{
  ...
  if (draw_targets)
  {
    for (var i = 0; i < legendas.getRowCount(); i++)
    {
      ...
      {
        print(targets[i].id, trials[current_trial]);
